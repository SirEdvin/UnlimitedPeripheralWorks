...
export type ItemDisplayOptions = DisplayOptions & {
    item_display?: string;
};
/** @noSelf **/
export interface HologramProjector extends ConfigurationAPI<{
    entityLimit: number;
...
export declare const hologramProjectorProvider: IPeripheralProvider<HologramProjector>;
