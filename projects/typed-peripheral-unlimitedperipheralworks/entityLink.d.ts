...
import { AutomobilityAutomobileAPI, ManaAndArtificeConstructAPI } from "./integrations/entityLink";
/** @noSelf **/
export interface EntityLink extends IPeripheral, Partial<ManaAndArtificeConstructAPI>, Partial<AutomobilityAutomobileAPI>, Partial<ExtendedInventoryAPI>, Partial<ItemStorageAPI>, Partial<FluidStorageAPI> {
