...
export type NeuralModelProgression = {
    /** Native tier name, including data-driven HNN tiers and Extra HNN's autonomous through omnipotent tiers. */
    rank: string;
 ...
 * This entity-based API does not expose HNN 6.5 block models or combined models containing them.
...
export interface LootFabricator extends IPeripheral {
     ...
     * On HNN 6.5+, selects native fixed mode, replacing any queue for this model.
