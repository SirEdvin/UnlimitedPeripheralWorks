...
export declare const miCrafterProvider: IPeripheralProvider<ModernIndustrializationCrafter>;
export declare const alloyForgeryProvider: IPeripheralProvider<AlloyForgeryController>;
