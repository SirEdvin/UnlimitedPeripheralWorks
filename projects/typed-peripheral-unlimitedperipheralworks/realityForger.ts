...
/** @noSelf **/
export interface RealityForger
    extends ConfigurationAPI<{ interactionRadius: number }> {
...
export const realityForgerProvider = new IPeripheralProvider<RealityForger>(
    "reality_forger"
);
