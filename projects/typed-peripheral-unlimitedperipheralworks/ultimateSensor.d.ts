...
export type SensorInspector = "dimension" | "biome" | "weather" | "orientation" | "time" | "light" | "calendar" | "chunk";
/** @noSelf **/
...
export declare const ultimateSensorProvider: IPeripheralProvider<UltimateSensor>;
