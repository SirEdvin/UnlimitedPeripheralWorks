...
/** @noSelf **/
export interface RemoteObserver extends ConfigurationAPI<RemoteObserverConfiguration> {
...
export declare const remoteObserverProvider: IPeripheralProvider<RemoteObserver>;
