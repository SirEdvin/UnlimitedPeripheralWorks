...
check(terminal.pushItem("minecraft:stone", 5, 1) === 5, "Stone was not pushed into slot 1");
check(terminal.pushItem("minecraft:dirt") === 0, "Missing dirt unexpectedly moved");
check(terminal.pullItem("minecraft:gold_ingot", 3, 16) === 3, "Gold was not pulled from slot 16");
...
check(!pcall(() => terminal.pushItem(undefined, undefined, 17))[0], "Invalid slot was accepted");
