import type { AE2CableAPI, AE2PatternProviderPeripheral } from "@siredvin/typed-peripheral-unlimitedperipheralworks/integrations/ae2Objects";
...
check(object.getDeviceType() === "pattern_provider", `Expected pattern_provider, got ${object.getDeviceType()}`);
