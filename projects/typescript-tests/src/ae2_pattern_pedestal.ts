...
const processing: AE2ProcessingDefinition = {
    inputs: [item("minecraft:cobblestone", '{"minecraft:custom_data":{custom:"value"}}'), { type: "fluid", name: "minecraft:water", count: 1000, snbt: '{"minecraft:custom_data":{custom:"fluid"}}' }, item("minecraft:cobblestone", '{"minecraft:custom_data":{custom:"value"}}')],
...
const smithing = {
    ...
    base: item("minecraft:diamond_sword", '{"minecraft:damage":7,"minecraft:custom_name":\'{"text":"Exact sword"}\'}'),
