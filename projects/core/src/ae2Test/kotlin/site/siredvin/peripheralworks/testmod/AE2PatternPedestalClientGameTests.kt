...
class AE2PatternPedestalClientGameTests {
    ...
    fun rendersSynchronizedPattern(helper: GameTestHelper) {
        ...
        screenshot.delete()
        val pattern = PatternDetailsHelper.encodeProcessingPattern(listOf(GenericStack(AEItemKey.of(Items.STONE), 1)), listOf(GenericStack(AEItemKey.of(Items.DIAMOND), 1)))
