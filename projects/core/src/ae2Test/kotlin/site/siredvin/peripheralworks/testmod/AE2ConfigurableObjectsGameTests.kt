        ...
        (helper.level.getBlockEntity(chestPos) as ChestBlockEntity).apply {
            ...
            setItem(
                ...
                PatternDetailsHelper.encodeProcessingPattern(
                    listOf(GenericStack(AEItemKey.of(Items.COBBLESTONE), 2), GenericStack(AEFluidKey.of(Fluids.WATER), fluidUnit * 1_000)),
                    listOf(GenericStack(AEItemKey.of(Items.STONE), 1), GenericStack(AEFluidKey.of(Fluids.LAVA), fluidUnit * 250)),
                ),
            )
        }
        helper.startSequence()
