...
class PeripheralWorksGameTests {
    ...
    fun configuratorFavoritesAreOrderedBoundedAndNamed(helper: GameTestHelper) {
        ...
        check(configurator.setSettings(stack, "Field Kit", 0xabcdef, 0xfedcba))
        check(stack.hoverName.string == "Field Kit")
        check(configurator.getFavoriteTextColor(stack) == 0xabcdef)
        check(configurator.getFavoriteBoxColor(stack) == 0xfedcba)
