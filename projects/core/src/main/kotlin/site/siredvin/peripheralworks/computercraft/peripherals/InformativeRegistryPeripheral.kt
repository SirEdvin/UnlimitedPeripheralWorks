    ...
    companion object {
        ...
        init {
            ...
            addList(
                ...
                { _level, it ->
                    val id = ResourceLocation.tryParse(it) ?: return@addList MethodResult.of(null)
                    val entityType = PlatformRegistries.ENTITY_TYPES.tryGet(id) ?: return@addList MethodResult.of(null)
            ...
            addList(
                ...
                { _level, it ->
                    val id = ResourceLocation.tryParse(it) ?: return@addList MethodResult.of(null)
                    val item = PlatformRegistries.ITEMS.tryGet(id) ?: return@addList MethodResult.of(null)
            ...
            addList(
                ...
                { _level, it ->
                    val id = ResourceLocation.tryParse(it) ?: return@addList MethodResult.of(null)
                    val blockState = (PlatformRegistries.BLOCKS.tryGet(id) ?: return@addList MethodResult.of(null)).defaultBlockState()
            ...
            addList(
                ...
                { _level, it ->
                    val id = ResourceLocation.tryParse(it) ?: return@addList MethodResult.of(null)
                    val fluid = PlatformRegistries.FLUIDS.tryGet(id) ?: return@addList MethodResult.of(null)
