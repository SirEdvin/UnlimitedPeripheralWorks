...
class PeripheraliumHubPocketUpgrade(private val maxUpdateCount: Supplier<Int>, private val type: String, item: ItemStack) : StatefulPocketUpgrade<PocketPeripheraliumHubPeripheral>(
