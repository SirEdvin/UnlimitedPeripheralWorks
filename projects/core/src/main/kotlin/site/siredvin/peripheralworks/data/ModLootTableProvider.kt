...
object ModLootTableProvider {
    private val blockHooks = mutableListOf<BiConsumer<LootTableHelper, BiConsumer<ResourceLocation, LootTable.Builder>>>()

    fun addBlockHook(hook: BiConsumer<LootTableHelper, BiConsumer<ResourceLocation, LootTable.Builder>>) {
        blockHooks.add(hook)
    }
