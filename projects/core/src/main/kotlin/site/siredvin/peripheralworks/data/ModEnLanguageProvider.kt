...
class ModEnLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.NETWORK_MANAGER_GROUP_MEMBERSHIP_TOGGLED, "Peripheral group membership updated")
        add(ModText.NETWORK_MANAGER_UNAVAILABLE, "The bound network manager is unavailable")
        ...
        add(ModText.NETWORK_MANAGER_MEMBERSHIP_SEARCH, "Search peripherals or types")
        add(ModText.NETWORK_MANAGER_CREATE, "Create")
        add(ModText.NETWORK_MANAGER_RENAME, "Rename selected group")
        add(ModText.NETWORK_MANAGER_COLOR, "Color (#RRGGBB or -1)")
        add(ModText.NETWORK_MANAGER_COLOR_PICKER, "Open RGB color picker")
        add(ModText.NETWORK_MANAGER_VISIBILITY, "Group visibility: %s")
        add(ModText.NETWORK_MANAGER_VISIBILITY_DEFAULT, "by mode")
        add(ModText.NETWORK_MANAGER_VISIBILITY_SHOW, "always show")
        add(ModText.NETWORK_MANAGER_VISIBILITY_HIDE, "always hide")
        add(ModText.NETWORK_MANAGER_RENDER_SELECTED, "Selected hierarchy")
        add(ModText.NETWORK_MANAGER_RENDER_GROUPED, "Other groups")
        add(ModText.NETWORK_MANAGER_RENDER_UNGROUPED, "Ungrouped")
        add(ModText.NETWORK_MANAGER_TEXT_STYLE, "Text: %s")
        add(ModText.NETWORK_MANAGER_BOX_STYLE, "Box: %s")
        add(ModText.NETWORK_MANAGER_STYLE_NONE, "none")
        add(ModText.NETWORK_MANAGER_TEXT_REGULAR, "regular")
        ...
        add(ModText.NETWORK_MANAGER_SAVE_SETTINGS, "Save settings")
        add(ModText.NETWORK_MANAGER_DELETE, "Delete")
        add(ModText.NETWORK_MANAGER_DELETE_TOOLTIP, "Permanently deletes the group and all memberships")
        add(ModText.NETWORK_MANAGER_DELETE_CONFIRM, "Delete group %s?")
        add(ModText.NETWORK_MANAGER_DELETE_WARNING, "This also removes every membership and cannot be undone.")
        add(ModText.NETWORK_MANAGER_SELECT_GROUP, "Select a group on the Groups tab")
        add(ModText.NETWORK_MANAGER_SELECTED, "Selected: %s")
        add(ModText.NETWORK_MANAGER_INVALID_NAME, "Enter a group name from 1 to 64 characters")
        ...
        add(ModText.CONFIGURATOR_HISTORY_TITLE, "Configurator Targets")
        add(ModText.CONFIGURATOR_HISTORY_RECENT, "Recent")
        add(ModText.CONFIGURATOR_HISTORY_FAVORITES, "Favorites")
        add(ModText.CONFIGURATOR_HISTORY_EMPTY_RECENT, "No recent targets")
        add(ModText.CONFIGURATOR_HISTORY_EMPTY_FAVORITES, "No favorite targets")
        add(ModText.CONFIGURATOR_HISTORY_FAVORITE, "Favorite")
        add(ModText.CONFIGURATOR_HISTORY_UNFAVORITE, "Remove favorite")
        add(ModText.CONFIGURATOR_HISTORY_EDIT, "Edit")
        add(ModText.CONFIGURATOR_HISTORY_EDIT_TITLE, "Edit Favorite")
        add(ModText.CONFIGURATOR_HISTORY_RENAME, "Favorite name")
        add(ModText.CONFIGURATOR_HISTORY_APPLY, "Apply")
