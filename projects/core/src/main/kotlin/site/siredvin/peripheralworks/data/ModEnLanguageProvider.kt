...
class ModEnLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.NETWORK_MANAGER_RENDER_STYLE, "%s: %s")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_NONE, "none")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_TEXT, "text")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_BOLD_TEXT, "bold text")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_OUTLINE_BOX, "outline box")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_FILLED_BOX, "filled box")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_FLARE, "flare")
