...
class ModEnLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.NETWORK_MANAGER_VISUALIZATION, "Overlay: %s")
        add(ModText.NETWORK_MANAGER_VISUALIZATION_ALL, "everything")
        add(ModText.NETWORK_MANAGER_VISUALIZATION_SELECTED, "selected group")
        add(ModText.NETWORK_MANAGER_VISUALIZATION_SELECTED_AND_UNGROUPED, "selected + ungrouped")
        add(ModText.NETWORK_MANAGER_VISUALIZATION_UNGROUPED, "ungrouped")
