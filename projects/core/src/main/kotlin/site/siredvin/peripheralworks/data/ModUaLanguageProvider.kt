...
class ModUaLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.NETWORK_MANAGER_TEXT_STYLE, "%s текст: %s")
        add(ModText.NETWORK_MANAGER_BOX_STYLE, "%s блок: %s")
        add(ModText.NETWORK_MANAGER_STYLE_NONE, "нічого")
        add(ModText.NETWORK_MANAGER_TEXT_REGULAR, "звичайний")
