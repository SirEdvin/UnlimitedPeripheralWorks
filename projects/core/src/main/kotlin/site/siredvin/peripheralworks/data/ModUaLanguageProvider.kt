...
class ModUaLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.NETWORK_MANAGER_RENDER_SELECTED, "Вибрана ієрархія")
        add(ModText.NETWORK_MANAGER_RENDER_GROUPED, "Інші групи")
        add(ModText.NETWORK_MANAGER_RENDER_UNGROUPED, "Без групи")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE, "%s: %s")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_NONE, "нічого")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_TEXT, "текст")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_BOLD_TEXT, "жирний текст")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_OUTLINE_BOX, "контур блока")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_FILLED_BOX, "заповнений блок")
        add(ModText.NETWORK_MANAGER_RENDER_STYLE_FLARE, "сяйво")
