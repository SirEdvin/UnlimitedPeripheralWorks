...
class ModUaLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        add(ModText.CONFIGURATOR_HISTORY_TITLE, "Цілі конфігуратора")
        add(ModText.CONFIGURATOR_HISTORY_RECENT, "Останні")
        add(ModText.CONFIGURATOR_HISTORY_FAVORITES, "Обрані")
        add(ModText.CONFIGURATOR_HISTORY_EMPTY_RECENT, "Немає останніх цілей")
        add(ModText.CONFIGURATOR_HISTORY_EMPTY_FAVORITES, "Немає обраних цілей")
        add(ModText.CONFIGURATOR_HISTORY_FAVORITE, "Обрати")
        add(ModText.CONFIGURATOR_HISTORY_UNFAVORITE, "Прибрати з обраних")
        add(ModText.CONFIGURATOR_HISTORY_EDIT, "Змінити")
        add(ModText.CONFIGURATOR_HISTORY_EDIT_TITLE, "Змінити обрану ціль")
        add(ModText.CONFIGURATOR_HISTORY_RENAME, "Назва обраної цілі")
        add(ModText.CONFIGURATOR_HISTORY_APPLY, "Застосувати")
