...
class Integration : Runnable {
    ...
    fun forTurtle(turtle: ITurtleAccess, side: TurtleSide): NaturesCompassPeripheral<TurtlePeripheralOwner> = NaturesCompassPeripheral(TurtlePeripheralOwner(turtle, side), NaturesCompassConfiguration.enableNaturesCompassTurtleUpgrade)
