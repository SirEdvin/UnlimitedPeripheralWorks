...
- [ ] 5.4 Review the diff against both capability specifications, commit/push only the feature branch, and open a PR targeting `1.20`; verify the remote head and PR base, include honest test evidence and remaining CI state, and leave build outputs/logs/run directories uncommitted.
