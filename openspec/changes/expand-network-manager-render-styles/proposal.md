...
- Add none, text, bold text, outline box, filled box, and flare render styles.
- Let render-style buttons cycle forward with left click and backward with right click.
- Make box styles visually stronger and visible through intervening blocks.
- Apply the selected-group style to the selected group and all descendants.
- Use each group's configured color for box and flare styles, defaulting to white; keep text labels free of group-color styling.
