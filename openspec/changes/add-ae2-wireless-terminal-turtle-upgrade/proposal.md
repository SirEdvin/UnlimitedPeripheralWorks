...
- Allow a linked AE2 Wireless Crafting Terminal to be equipped directly as a turtle peripheral upgrade while preserving the terminal's complete item state.
...
- Add crafting requests, weak job tracking, and cancellation to the same wireless terminal peripheral.
- Keep item storage and crafting control on one Wireless Crafting Terminal upgrade; defer fluid storage and cross-dimensional access.

## Capabilities

### New Capabilities

- `ae2-wireless-terminal-turtle-upgrade`: Direct terminal equipping, state preservation, wireless connection validation, network item inspection, turtle-local transfers, fuel charging, crafting requests, weak crafting-job tracking, and typed Lua contracts.
...
- Typed peripheral sources for the combined wireless terminal.
