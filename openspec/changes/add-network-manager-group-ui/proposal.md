...
- Move overlay range and visualization mode configuration into the UI.
...
- Adds native Minecraft screens, synchronized network manager settings, and configurator NBT for expanded hierarchy paths and visualization mode.
